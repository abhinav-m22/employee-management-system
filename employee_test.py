...
class Employee:
    def __init__(self,root):
        ...
        lbl_tile=Label(self.root,text = "EMPLOYEE MANAGEMENT SYSTEM", font=('times new roman', 37, 'bold'),fg='darkblue',bg='white')
        ...
        # # 3rd Image
        # img_3=Image.open("images/1234.jpg")
        ...
        # Marriage Status
        lbl_married_status=Label(upper_frame, font=('arial',12,'bold'),text='Marriage Status:',bg='white')
        ...
        btn_search=Button(search_frame,bg='blue',text='Search',command=self.search_data,font=('arial',11,'bold'),fg='white',width=14)
        btn_search.grid(row=0,column=3,padx=5)

        btn_ShowAll=Button(search_frame,bg='blue',text="Show All",command=self.fetch_data,font=('arial',11,'bold'),fg='white',width=14)
        btn_ShowAll.grid(row=0,column=4,padx=5)

        # stayhome=Label(search_frame,bg='white',text='Wear a Mask',font=('times new roman',30,'bold'),fg='red')
        # stayhome.place(x=780,y=0,width=600,height=30)

# img_logo_mask=Image.open(r"collehr_images\mask.jpg")
# img_logo_mask=img_logo_mask.resize((50,50),Image.ANTIALIAS)
# self.photoimg_logo_mask=ImageTk.PhotoImage(img_logo_mask)

# self.logo=Lable(search_frame,image=self.photoimg_logo_mask)
# self.logo.place(x=900,y=0,width=50,height=30)
    ...
    def add_data(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root', password={MySQLPassword}, database='employeedb')
                ...
                self.fetch_data()
                conn.close() 
                messagebox.showinfo('Success','Employee has been addded!',parent=self.root)
